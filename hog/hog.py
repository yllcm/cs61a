...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    player_dig1 = player_score % 10
    opponent_dig2 = (opponent_score // 10) % 10
    return max(3 * abs(player_dig1 - opponent_dig2), 1)
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    roll_num, max_score, max_roll_num = 1, 0, 0
    while roll_num <= 10:
        now_roll = make_averaged(roll_dice, times_called)
        score = now_roll(roll_num, dice)
        if score > max_score:
            max_score, max_roll_num = score, roll_num
        roll_num += 1
    return max_roll_num
    # END PROBLEM 9
